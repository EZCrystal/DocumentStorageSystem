...
public class BTreeImpl<Key extends Comparable<Key>, Value> implements BTree<Key, Value> {
    ...
    private PersistenceManager storageHandler;
    ...
    public BTreeImpl() {
        ...
        this.storageHandler = new DocumentPersistenceManager(null);
    }
    ...
    public Value get(Key key) {
        ...
        if (entry != null && entry.val != null) {
        	//System.out.println("1: " + (Value)entry.val + " - " + key);
        	//System.out.println(1);
            return (Value)entry.val;
        } else {//entry == null
        	try {
        		//System.out.println(key);
        		Value val = (Value) this.storageHandler.deserialize(key);
        		//System.out.println("Get value: " + val);
        		this.put(key, val);
        		//System.out.println("Get value when call BTree.get: " + this.get(key));
        		//System.out.println("Key in BTREE: " + key);
        		//System.out.println(2);
        		//System.out.println("2: " + val + " - " + key);
        		return val;
        	} catch (Exception e) {
        		//e.printStackTrace();
        		//System.out.println("3: null - " + key);
    ...
    public void moveToDisk(Key k) throws IOException {
    	Value val = this.put(k, null);
    	this.storageHandler.serialize(k, val);
    }

    public void setPersistenceManager(PersistenceManager<Key,Value> pm) {
    	this.storageHandler = pm;
    }
}